...
const EjerciciosContent: React.FC<Props> = ({ setSelectedItem }) => {
  ...
  if (loading) return <p className="p-10">Cargando ejercicios...</p>;
      ...
      <div className="overflow-x-auto bg-white rounded-xl shadow">
        <table className="min-w-full divide-y divide-gray-200">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {ejercicios.map(ej => (
              <tr key={ej.id_ejercicio} className="hover:bg-gray-50 transition">
                <td className="px-6 py-4">{ej.nombre}</td>
                <td className="px-6 py-4">{ej.tipoEjercicio.nombre}</td>
                <td className="px-6 py-4">{ej.grupoMuscular.nombre}</td>
                <td className="px-6 py-4">{ej.estado || 'Activo'}</td>
...
export default EjerciciosContent;
